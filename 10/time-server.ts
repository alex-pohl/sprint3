...
const server = net.createServer((socket: any) => { //creamos servidor TCP. El tipo ANY: debería ser net.Socket según he descubierto pero no hay manera de que me lo acepte.
